...
def getMainStock(code:str):
    if code.startswith("SZ.000"):
        ...
        return False
stockCode = list(filter(getMainStock,allStockList))
usefulSet = set(usefulList)
def removeDotFromCode(code:str):
    return code.replace(".","")
removeDotList = list(map(removeDotFromCode,stockCode))
